...
export function reducer(
    ...
    action: fromExhibitorList.Actions
): State {
    switch (action.type) {
        case fromExhibitorList.FETCH_EXHIBITORS:
            return {
                ...state,
                loading: true
            }
        case fromExhibitorList.FETCH_EXHIBITORS_SUCCESS:
            return {
                ...state,
                exhibitors: action.exhibitors,
                loading: false
            }
        case fromExhibitorList.FETCH_EXHIBITORS_FAILURE:
            return {
                ...state,
                loading: false
            }

        case fromExhibitorList.FETCH_EXHIBITORS_COUNT_SUCCESS:
            return {
                ...state,
                exhibitorsCount: action.count
            }

        case fromExhibitorList.ENSURE_PAGE_PARAMS:
            return {
                ...state,
