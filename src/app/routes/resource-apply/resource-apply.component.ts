...
export class ResourceApplyComponent implements OnInit {
    ...
    hiddenAddReourceBtn$: Observable<boolean>
    ...
    private initFirstTabDataSource() {
        this.hiddenAddReourceBtn$ = this.store.select(getHiddenAddResourceBtn)
    ...
    private initSwitchApplyType() {
        this.type.valueChanges
            ...
            .subscribe(applyType => {
                this.store.dispatch(
                    new fromRequirementApply.SwitchApplyTypeAction(applyType)
                )
            })
    }
    ...
    private initSaveRequirementApply() {
        this.toSaveSub
            ...
            .subscribe(() => {
                this.store.dispatch(
                    new fromRequirementApply.SaveRequirementApplyAction()
                )
            })
    }
    ...
    private initSubmitRequirementApply() {
        this.toSubmitSub
            ...
            .subscribe(() => {
                this.store.dispatch(
                    new fromRequirementApply.SubmitRequirementApplyAction()
                )
            })
    }
    ...
    private initResetRequirementApply() {
        this.toResetSub
            ...
            .subscribe(() => {
                this.store.dispatch(
                    new fromRequirementApply.ResetRequirementApplyAction()
                )
            })
    }
    ...
    private initCreateApplyResource() {
        this.toCreateResourceSub
            ...
            .subscribe(resource => {
                this.store.dispatch(
                    new fromRequirementApply.CreateApplyResourceAction(resource)
                )
            })
    }
    ...
    private initAddApplyResources() {
        this.toAddResourcesSub
            ...
            .subscribe(resources => {
                this.store.dispatch(
                    new fromRequirementApply.AddApplyResourcesAction(resources)
                )
            })
    }
    ...
    private initEditTempApplyResource() {
        this.toEditTempResourceSub
            ...
            .subscribe(resource => {
                this.store.dispatch(
                    new fromRequirementApply.EditTempApplyResourceAction(
                        resource
                    )
                )
            })
        ...
        this.toDeleteResourceSub
            ...
            .subscribe(index => {
                this.modalService.confirm({
                    ...
                    onOk: () => {
                        this.store.dispatch(
                            new fromRequirementApply.DeleteApplyResourceAction(
                                index
                            )
                        )
                    }
    ...
    private initToShowSavedApply() {
        this.toDetailSavedApplySub
            ...
            .subscribe(apply => {
                this.store.dispatch(
                    new fromSavedApply.ToDetailSavedApplyAction(apply)
                )
            })
    }
    ...
    private initToEditSavedApply() {
        this.toEditSavedApplySub
            ...
            .subscribe(apply => {
                this.store.dispatch(
                    new fromSavedApply.ToEditSavedApplyAction(apply)
                )
            })
    }
        ...
        this.toSubmitSavedApplySub
            ...
            .subscribe(apply => {
                this.modalService.confirm({
                    ...
                    onOk: () => {
                        this.store.dispatch(
                            new fromSavedApply.SubmitSavedApplyAction(apply)
                        )
                    }
                })
            })
        ...
        this.toDeleteSavedApplySub
            ...
            .subscribe(apply => {
                this.modalService.confirm({
                    ...
                    onOk: () => {
                        this.store.dispatch(
                            new fromSavedApply.DeleteSavedApplyAction(apply)
                        )
                    }
                })
            })
    ...
    private initNeedManualResetTabIndex() {
        this.store
            ...
            .subscribe(([_, tabIndex]) => {
                ...
                this.store.dispatch(
                    new fromExtraTabs.ResetNeedManualSetTabIndexAction()
                )
            })
    }
