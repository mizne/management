...
@Component({
    selector: 'app-to-edit-resource-info',
    templateUrl: './to-edit-resource-info.component.html',
    providers: [DestroyService]
})
export class ToEditResourceInfoComponent implements OnInit {
    form: FormGroup
    ...
    @Input()
    set resourceInfo(v: ResourceInfo) {
    ...
    private patchForm() {
        this.form.patchValue(this._resourceInfo)
    }
}
