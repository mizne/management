...
export class PhysicalServerAccountEffects {
    ...
    fetchPhysicalServerAccounts$ = this.actions$
        ...
        .pipe(
            ...
            switchMap(params => this.serverAccountService.fetchPhysicalServerAccounts(params)),
            map(accounts => new fromPhysicalServerAccount.FetchPhysicalServerAccountsSuccessAction(
                accounts
            )),
            catchError(() => of(new fromPhysicalServerAccount.FetchPhysicalServerAccountsFailureAction()))
        )
    ...
    fetchPhysicalServerAccountsCount$ = this.actions$
        ...
        .pipe(
            ...
            switchMap(searchText => this.serverAccountService.fetchPhysicalServerAccountsCount(searchText)),
            map((count) => new fromPhysicalServerAccount.FetchPhysicalServerAccountsCountSuccessAction(
                count
            )),
            catchError(() => of(new fromPhysicalServerAccount.FetchPhysicalServerAccountsCountFailureAction()))
        )
    ...
    createPhysicalServerAccount$ = this.actions$
        ...
        .pipe(
            ...
            switchMap(account => this.serverAccountService.createPhysicalServerAccount(account)),
            concatMap(() => [
            ...
            catchError(() => of(new fromPhysicalServerAccount.CreatePhysicalServerAccountFailureAction()))
        )
    ...
    editPhysicalServerAccount$ = this.actions$
        ...
        .pipe(
            ...
            switchMap(account => this.serverAccountService.editPhysicalServerAccount(account)),
            concatMap(() => [
                new fromPhysicalServerAccount.EditPhysicalServerAccountSuccessAction(),
                new fromPhysicalServerAccount.FetchPhysicalServerAccountsAction()
            ]),
            catchError(() => of(new fromPhysicalServerAccount.EditPhysicalServerAccountFailureAction()))
        )
