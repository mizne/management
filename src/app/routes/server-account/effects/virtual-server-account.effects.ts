...
export class VirtualServerAccountEffects {
    ...
    fetchVirtualServerAccounts$ = this.actions$
        ...
        .pipe(
            ...
            switchMap(params => this.serverAccountService.fetchVirtualServerAccounts(params)),
            map((accounts) => new fromVirtualServerAccount.FetchVirtualServerAccountsSuccessAction(
                accounts
            )),
            catchError(() => of(new fromVirtualServerAccount.FetchVirtualServerAccountsFailureAction()))
        )
    ...
    fetchVirtualServerAccountsCount$ = this.actions$
        ...
        .pipe(
            ...
            switchMap(searchText => this.serverAccountService.fetchVirtualServerAccountsCount(searchText)),
            map(count => new fromVirtualServerAccount.FetchVirtualServerAccountsCountSuccessAction(
                count
            )),
            catchError(() => of(new fromVirtualServerAccount.FetchVirtualServerAccountsCountFailureAction()))
        )
    ...
    createVirtualServerAccount$ = this.actions$
        ...
        .pipe(
            ...
            switchMap(account => this.serverAccountService.createVirtualServerAccount(account)),
            concatMap(() => [
            ...
            catchError(() => of(new fromVirtualServerAccount.CreateVirtualServerAccountFailureAction()))
        )
    ...
    editVirtualServerAccount$ = this.actions$
        ...
        .pipe(
            ...
            switchMap(account => this.serverAccountService.editVirtualServerAccount(account)),
            concatMap(() => [
                new fromVirtualServerAccount.EditVirtualServerAccountSuccessAction(),
                new fromVirtualServerAccount.FetchVirtualServerAccountsAction()
            ]),
            catchError(() => of(new fromVirtualServerAccount.EditVirtualServerAccountFailureAction()))
        )
